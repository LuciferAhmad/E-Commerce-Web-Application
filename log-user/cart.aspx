<%@ Page Title="" Language="C#" MasterPageFile="~/log-user/LogUserMasterPage.master" AutoEventWireup="true" CodeFile="cart.aspx.cs" Inherits="cart" %>
                        ...
                        <table style="width: 789px; height: 53px">
                            <tr>
                                ...
                                <td class="auto-style11">
                                    <asp:Button ID="Button2" runat="server" Height="26px" Text="Proceed To Buy" CommandName="proceed" OnCommand="Button2_Command"  CommandArgument='<%# Eval("pid") %>' />
                                </td>
                            </tr>
                        </table>
<br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Cart] WHERE ([name] = @name)">
                    <SelectParameters>
